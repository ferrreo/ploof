...
const response_gzip = @import("response_gzip.zig");
const route = @import("route.zig");
const application_context = @import("application_context.zig");
const application_asset_runtime = @import("internal/application_asset_runtime.zig");
const application_assets = @import("internal/application_assets.zig");
const application_compile = @import("internal/application_compile.zig");
const application_chunk_output = @import("internal/application_chunk_output.zig");
const application_csrf = @import("internal/application_csrf.zig");
const app_cors = @import("internal/application_cors.zig");
const application_body = @import("internal/application_body.zig");
const application_endpoint_output = @import("internal/application_endpoint_output.zig");
const application_head = @import("internal/application_head.zig");
const application_head_setup = @import("internal/application_head_setup.zig");
const application_json_response = @import("internal/application_json_response.zig");
const application_lifecycle_bridge = @import("internal/application_lifecycle_bridge.zig");
const application_multipart_lifecycle = @import("internal/application_multipart_lifecycle.zig");
const application_metrics_binding = @import("internal/application_metrics_binding.zig");
const application_pipeline = @import("internal/application_pipeline.zig");
const application_prepare_binding = @import("internal/application_prepare_binding.zig");
const application_prepare_direct = @import("internal/application_prepare_direct.zig");
const application_response_output = @import("internal/application_response_output.zig");
const application_response_body = @import("internal/application_response_body.zig");
const application_runtime = @import("internal/application_runtime.zig");
const application_selected_body = @import("internal/application_selected_body.zig");
const application_serve_bridge = @import("internal/application_serve_bridge.zig");
const application_static = @import("internal/application_static.zig");
const application_static_response = @import("internal/application_static_response.zig");
const application_types = @import("internal/application_types.zig");
const application_upload_catalog = @import("internal/application_upload_catalog.zig");
...
pub fn Application(comptime config: anytype) type {
    ...
    const output_plans = comptime application_assets.appendRepeated(
        ...
        @import("internal/application_finite_output.zig").Plan.contiguous,
    );
