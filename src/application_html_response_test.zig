...
const worker_response_chunks = @import("internal/runtime/worker_response_chunks.zig");
...
fn prepareGzip(
    ...
    pool: anytype,
    preferences: @import("internal/http1/request_accept_encoding.zig").Preferences,
) !application.Prepared {
    var gzip: GzipApp.ResponseGzipWorkspace = undefined;
