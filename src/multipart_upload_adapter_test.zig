...
const adapter = @import("internal/multipart_upload_adapter.zig");
const upload_layout = @import("internal/multipart_upload_layout.zig");
const sink_driver = @import("internal/upload_sink_driver.zig");
