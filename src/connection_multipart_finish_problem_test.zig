...
const body_runtime = @import("internal/runtime/connection_body_runtime.zig");
...
const gzip_encoder = @import("internal/runtime/gzip_encoder.zig");
...
const EmptyChunked = struct {
    ...
    const fields: []const @import("internal/http1/request_head.zig").Field = &.{};
