...
const compile = @import("internal/html_template_compile.zig");
const diagnostic = @import("internal/html_template_diagnostic.zig");
const runtime = @import("internal/html_template_runtime.zig");
const types = @import("internal/html_template_types.zig");
