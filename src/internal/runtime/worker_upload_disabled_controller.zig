...
const registry_support = @import("worker_upload_runtime_registry_support.zig");
const worker_metrics = @import("worker_metrics.zig");
const StartupDiagnostic = @import("../multipart_file_sink_startup_diagnostic.zig").Diagnostic;
const RouteMetricsSnapshot = @import("worker_upload_route_metrics.zig").Snapshot;
...
const upload_sink_driver = @import("../upload_sink_driver.zig");
