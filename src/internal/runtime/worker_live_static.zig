...
const live_static_completion = @import("worker_live_static_completion.zig");
const live_static_io = @import("worker_live_static_io.zig");
const live_static_root = @import("worker_live_static_root.zig");
const live_static_stage = @import("worker_live_static_stage.zig");
