const split = @import("worker_live_static_fuzz_support.zig");
pub const std = @import("std");
pub const application = @import("../../application.zig");
pub const response = @import("../../response.zig");
pub const static_file = @import("../../static_file.zig");
pub const config = @import("config.zig");
pub const connection_driver = @import("connection_driver.zig");
pub const deterministic_reactor = @import("deterministic_reactor.zig");
...
pub fn settleDriverRootTarget(
    ...
    result: reactor.CompletionResult,
    now_ns: u64,
) !@import("worker_live_static.zig").Event {
    try io.complete(target.token, result, false);
    try std.testing.expectEqual(
        @import("worker_live_static.zig").Event.none,
