...
pub const application_context = @import("application_context.zig");
pub const csrf = @import("csrf.zig");
pub const csrf_origin = @import("internal/csrf_origin.zig");
pub const csrf_request = @import("internal/csrf_request.zig");
pub const forwarding = @import("forwarding.zig");
pub const limits = @import("internal/http1/limits.zig");
pub const request_head = @import("internal/http1/request_head.zig");
...
pub fn mockContext(
    ...
    return .{
        ...
        .request = .{
            ...
            .scheme = .https,
            .authority = try @import("internal/http1/authority.zig").parse(
                "app.example",
                .https,
            ),
        },
...
pub fn expectForgedOriginSet(expected: csrf.OriginSetIssue, set: Origins) !void {
    ...
    const authority = try @import("internal/http1/authority.zig").parse(
        "app.example",
        .https,
    );
