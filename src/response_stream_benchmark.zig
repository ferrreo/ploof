...
const Erased = @import("internal/response_stream_erasure.zig").Erased(128, 16);
const response_framing = @import("internal/http1/response_framing.zig");
...
const stream_transport = @import("internal/runtime/connection_stream_transport.zig");
const worker_stream_wake = @import("internal/runtime/worker_stream_wake.zig");
